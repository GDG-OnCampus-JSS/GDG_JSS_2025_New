...
export default function InstagramEmbed({ url }: { url: string }) {
  ...
  return (
   <div className="relative w-full h-full max-w-135 min-h-112 bg-white border border-gray-200 rounded-xl shadow-sm flex flex-col items-center p-2 mx-auto" ref={containerRef}>
    {!isLoaded && (
      ...
      >
        <a href={url} target="_blank" rel="noopener noreferrer" className="text-xs text-gray-400">
